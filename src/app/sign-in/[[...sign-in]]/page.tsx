  ...
  return (
    <div className="relative grid min-h-svh place-items-center overflow-hidden px-4 py-12">
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute left-1/2 top-1/4 h-[520px] w-[820px] -translate-x-1/2 rounded-full bg-gradient-radial from-accent/15 to-transparent blur-3xl" />
        <div className="absolute right-1/4 bottom-0 h-[400px] w-[400px] rounded-full bg-gradient-radial from-mint/10 to-transparent blur-3xl" />
      </div>
